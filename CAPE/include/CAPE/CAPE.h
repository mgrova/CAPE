...
public:
	...
	~CAPE(void);
	void process(Eigen::MatrixXf & cloud_array, int & nr_planes, int & nr_cylinders, cv::Mat & seg_output, std::vector<PlaneSeg> & plane_segments_final, std::vector<CylinderSeg> & cylinder_segments_final);
